...
val modOne = Module(
    ...
    listOf(docDetails("daysfriends", "Script", R.drawable.script), docDetails("answerone", "Answers", R.drawable.key))
)
...
val modTwo = Module(
    ...
    listOf(docDetails("daysfriends", "Script", R.drawable.script))
)
